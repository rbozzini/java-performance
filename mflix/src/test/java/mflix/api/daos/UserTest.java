...
public class UserTest extends TicketTest {
	...
	public void testRegisterUser() {
		...
		assertTrue("Should have correctly created the user - check your write user method", dao.addUser(testUser)); // add
																													// string
																													// explanation
	...
	public void testLogin() {
		...
		assertEquals("The user email needs to match the `session` user_id field", testUser.getEmail(),
				session.getUserId());
	...
	public void testLogout() {
		...
		assertTrue("Should have deleted user from sessions collection - check your logout method",
				dao.deleteUser(email));

		try {
			dao.getUserSession(email);
...
//		assertNull("All sessions for user should have been deleted after logout", session);
	...
	public void testDeleteUser() {
		dao.addUser(testUser);
		assertTrue("You should be able to delete correctly the testDb user. Check your delete filter",
